...
import Virtualshop from './Virtualshop';
...
function Demo() {
  ...
  return (
   ...
   <br></br>
      ...
      <div class="space"></div>
      <link rel="stylesheet" type="text/css" href="./vanilla-toast.css"></link>
     ...
     < img src={floatarea} id="floatarea" style={{ position: 'relative', top: 545, left: -65 }}/>
      ...
      < img src={helipad} id="heli" alt="helipad" style={{ position: 'relative', top: 110, left: 165 }}/>
